...
function help() {
  console.log(`agentignore-check v0.1.1

Usage:
  agentignore-check --path FILE
  agentignore-check FILE --markdown
  agentignore-check FILE --sarif > results.sarif
  agentignore-check FILE --annotations
  agentignore-check FILE --redact
...
try {
  ...
  console.error(`agentignore-check: ${error.message}`)
  process.exit(2)
}
